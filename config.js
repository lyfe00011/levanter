...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_19b6ff89a022c64b86b962349b7fbe3da6').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,',
  ...
  MAX_UPLOAD: process.env.MAX_UPLOAD || 400,
