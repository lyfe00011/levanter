...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_16bfcda984d6e7496d90e2a14cb9e31a9b').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || '923012707501',
  ...
  MAX_UPLOAD: process.env.MAX_UPLOAD || 1000,
