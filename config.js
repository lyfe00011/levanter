...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_1853509cb988a04e1a86c4728696780245').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || '989876543210',
  ...
  MAX_UPLOAD: process.env.MAX_UPLOAD || 200,
  ...
  PERSONAL_MESSAGE: (process.env.PERSONAL_MESSAGE || 'null').config.env(),
